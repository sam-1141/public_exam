...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'Webapp' => [
            'driver' => 'mysql',
            'url' => env('WEBAPP_DB_URL'),
            'host' => env('WEBAPP_DB_HOST', '127.0.0.1'),
            'port' => env('WEBAPP_DB_PORT', '3306'),
            'database' => env('WEBAPP_DB_DATABASE', 'laravel'),
            'username' => env('WEBAPP_DB_USERNAME', 'root'),
            'password' => env('WEBAPP_DB_PASSWORD', ''),
            'unix_socket' => env('WEBAPP_DB_SOCKET', ''),
            'charset' => env('WEBAPP_DB_CHARSET', 'utf8mb4'),
            'collation' => env('WEBAPP_DB_COLLATION', 'utf8mb4_unicode_ci'),
            'prefix' => '',
            'prefix_indexes' => true,
            'strict' => true,
            'engine' => null,
